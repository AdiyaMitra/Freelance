        ...
        <section className=" relative overflow-hidden bg-gray-200 rounded-2xl md:rounded-[30px] mx-auto max-w-7xl shadow-xl border border-gray-100 mt-8 mb-16">
            ...
            {hasBackgroundShapes && (
                <div>
                    ...
                    <img className='absolute h-220 -mt-6 ml-1 sm:h-240 md:h-140 md:-mt-1 md:ml-32 lg:h-190 lg:-mt-10 lg:ml-6' src={BackgroundShape} alt="" />
                ...
                <div className=' p-6 md:p-12 lg:p-16 flex flex-col items-start text-left sm:w-[45%] md:w-[45%] lg:w-[45%]'>
                    <div className='text-xl sm:text-2xl md:text-3xl lg:text-5xl font-black leading-tight text-center sm:text-left'>
                        <svg
                            ...
                            <path d="M0.092549 9.86503L89.9952 1.05892C102.601 -0.175862 113.762 9.18663 114.738 21.8154L116.897 49.7602L120.835 100.711L128.178 195.721C129.216 209.159 118.34 220.514 104.87 220.056L75.9176 219.071" stroke="#FB4D17" stroke-width="1.8989" />
                        </svg>

                        <div className='bg-[#F94D1C] text-white p-3 px-6 rounded-2xl w-fit mx-auto sm:mx-0 rotate-3 z-30 mb-[-1rem]'>
                        ...
                        <div className='bg-[#F94D1C] text-white p-3 px-6 rounded-2xl w-fit mx-auto sm:mx-0 -rotate-3 z-30 mt-[-1rem]'>
                            <div className='rotate-3'>
                                {title.hilighted2}
                            </div>
                        </div>
                    ...
                    <div>
                        <button className=" text-[12px] border border-black/50 sm:text-xl md:text-2xl lg:text-3xl mt-6 inline-block bg-[#F94D1C] hover:bg-[#FF6A3D] text-white text-lg font-normal py-4 px-10 rounded-full transition duration-300 ease-in-out shadow-[0_6px_0_0_#d74418] hover:shadow-[0_2px_0_0_#d74418]">{ctaText}</button>
                    </div>
                </div>
